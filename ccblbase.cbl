      ...
      -    "ts :".
        ...
        01 WS-DISPLAY-LI PIC X(15) VALUE "Libellé :".
        01 WS-DISPLAY-LIFULL PIC X(30).
        01 WS-DISPLAY-ST PIC X(15) VALUE "Statut :".
       01  WS-DISPLAY-STFULL PIC X(30).
      ...
      *    de sortie.
           ...
           STRING WS-DISPLAY-ST DELIMITED BY SIZE, SPACE,
              STATUT(WS-IDX) DELIMITED BY SIZE
             INTO WS-DISPLAY-STFULL.
           WRITE F-DATA-RAPPORT FROM WS-DISPLAY-STFULL.
           WRITE F-DATA-RAPPORT FROM WS-TIRET.
